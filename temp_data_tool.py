...
def run_pipeline():
    ...
    for entry in entries:
        ...
        # 4. API Update
        api_client.update_cover_via_api(student_dir, entry['meta'], bg_version="red")
        api_client.update_cover_via_api(student_dir, entry['meta'], bg_version="blue")
